<div class="section screen">
  <div class="screen1">
    <div class="imageBox">
      <div id="dropZone"><div><p>Dieses Werkzeug wandelt Bilder in schwarz-grüne Bilder für ROBIN WOOD-Veröffentlichungen um.</p>
                              <p>Bild hier hereinziehen oder unten hochladen.</p></div></div>
      <div class="controls">
